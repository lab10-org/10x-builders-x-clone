  ...
  return (
    <article className="flex gap-3 border-b border-gray-800 px-4 py-3 hover:bg-white/5 transition-colors">
      <div className="shrink-0">
        <Link to={profilePath} aria-label={`Ver perfil de ${author.display_name}`}>
          {author.avatar_url ? (
            <img
            ...
            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-700 text-white font-bold text-sm hover:opacity-80 transition">
      ...
      <div className="min-w-0 flex-1">
        ...
        <p className="mt-1 text-white text-sm whitespace-pre-wrap wrap-break-word">
          {tweet.content}
        </p>
      </div>
    </article>
